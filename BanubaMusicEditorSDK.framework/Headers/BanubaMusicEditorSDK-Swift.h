...
typedef SWIFT_ENUM(NSInteger, AVAudioEngineUnit, open) {
  AVAudioEngineUnitTimePitch = 0,
  AVAudioEngineUnitReverb = 1,
  AVAudioEngineUnitDelay = 2,
};

typedef SWIFT_ENUM(NSInteger, AVAudioEngineUnitParameter, open) {
  AVAudioEngineUnitParameterPitch = 0,
  AVAudioEngineUnitParameterRate = 1,
  AVAudioEngineUnitParameterWetDryMix = 2,
  AVAudioEngineUnitParameterDelayTime = 3,
  AVAudioEngineUnitParameterFeedback = 4,
};
...
@interface BaseTrackSelectionViewController : UINavigationController <TrackSelectionViewController>
@property (nonatomic, weak) id <TrackSelectionViewControllerDelegate> _Nullable trackSelectionDelegate;
...
@protocol EffectSelectionViewControllerDelegate
- (void)effectSelectionViewControllerWithViewController:(id <EffectSelectionViewController> _Nonnull)viewController didSelectFile:(NSURL * _Nonnull)url isEditable:(BOOL)isEditable title:(NSString * _Nonnull)title id:(int32_t)id;
...
@property (nonatomic, strong) BackgroundConfiguration * _Nonnull controlsBackgroundConfiguration;
...
SWIFT_CLASS("_TtCC20BanubaMusicEditorSDK11MusicEditor23BackgroundConfiguration")
...
@protocol TrackSelectionViewControllerDelegate
- (void)trackSelectionViewControllerWithViewController:(id <TrackSelectionViewController> _Nonnull)viewController didSelectFile:(NSURL * _Nonnull)url isEditable:(BOOL)isEditable title:(NSString * _Nonnull)title id:(int32_t)id;
...
- (nonnull instancetype)initWithDoneButtonImageName:(NSString * _Nonnull)doneButtonImageName doneButtonTintColor:(UIColor * _Nonnull)doneButtonTintColor sliderTintColor:(UIColor * _Nonnull)sliderTintColor mainLabelColors:(UIColor * _Nonnull)mainLabelColors additionalLabelColors:(UIColor * _Nonnull)additionalLabelColors backgroundConfiguration:(BackgroundConfiguration * _Nonnull)backgroundConfiguration height:(CGFloat)height OBJC_DESIGNATED_INITIALIZER;
/// Image name setups done button UIImage
@property (nonatomic, copy) NSString * _Nonnull doneButtonImageName;
/// Done button tint color
@property (nonatomic, strong) UIColor * _Nonnull doneButtonTintColor;
...
typedef SWIFT_ENUM(NSInteger, VoiceEffects, open) {
  VoiceEffectsBaritone = 301,
  VoiceEffectsEcho = 302,
  VoiceEffectsElf = 303,
  VoiceEffectsGiant = 304,
  VoiceEffectsRobot = 305,
  VoiceEffectsSquirrel = 306,
};
...
@property (nonatomic, readonly) enum VoiceEffects type;
@property (nonatomic, copy) NSString * _Nullable title;
@property (nonatomic, strong) UIColor * _Nonnull color;
@property (nonatomic, strong) UIImage * _Nullable image;
- (nonnull instancetype)initWithType:(enum VoiceEffects)type title:(NSString * _Nullable)title color:(UIColor * _Nullable)color image:(UIImage * _Nullable)image OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Available voice filter IDs
@property (nonatomic, copy) NSArray<NSNumber *> * _Nullable availableVoiceFilterIDs;
/// \param cornerRadius Container layer corner radius
///
/// \param imageCornerRadius UIImageView layer corner radius
///
/// \param imageEdgeInsets UIImage edge insets
///
